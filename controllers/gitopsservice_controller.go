...
//+kubebuilder:rbac:groups=argoproj.io,resources=argocds;argocds/finalizers;argocds/status;applications/status;applications;appprojects,verbs=get;list;watch;create;delete;patch;update
